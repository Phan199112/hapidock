...
server.connection({
    ...
    port: 3001,
    routes: {
        cors: { origin: ['http://www.crowleymarine.com', 'https://cart.crowleymarine.com', 'http://localhost', 'http://localhost:3000'] }
    }
});
...
const provision = async () => {
    ...
    try {
        ...
        await server.auth.strategy('admin_ips', 'ip-whitelist', ['179.7.148.90','206.189.8.53','190.234.11.171','73.181.122.139','46.17.43.171', '104.237.86.160']);
